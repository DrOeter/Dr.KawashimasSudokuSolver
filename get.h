...
void MainWindow::getUi(){
    ...
    line.push_back( 4 );//ui->b8->text().toInt() );
    line.push_back( ui->b9->text().toInt() );

    field.push_back(line);
    line.clear();

    line.push_back( 9 );//ui->c1->text().toInt() );
    line.push_back( ui->c2->text().toInt() );
    line.push_back( ui->c3->text().toInt() );
    line.push_back( 7 );//ui->c4->text().toInt() );
    ...
    line.push_back( 6 );//ui->d1->text().toInt() );
    line.push_back( ui->d2->text().toInt() );
    line.push_back( 2 );//ui->d3->text().toInt() );
    line.push_back( 5 );//ui->d4->text().toInt() );
    line.push_back( 3 );//ui->d5->text().toInt() );
    ...
    line.push_back( 3 );//ui->f9->text().toInt() );
    ...
    line.push_back( 3 );//ui->g3->text().toInt() );
    line.push_back( ui->g4->text().toInt() );
    line.push_back( 1 );//ui->g5->text().toInt() );
    ...
    line.push_back( 9 );//ui->h2->text().toInt() );
    line.push_back( ui->h3->text().toInt() );
    line.push_back( 2 );//ui->h4->text().toInt() );
    ...
    line.push_back( 7 );//ui->h9->text().toInt() );

    field.push_back(line);
    line.clear();

    line.push_back( 4 );//ui->i1->text().toInt() );
